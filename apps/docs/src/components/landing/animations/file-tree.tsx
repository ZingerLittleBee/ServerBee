...
export function FileTreeAnim() {
  return (
    <div
      ...
      role="img"
    >
      <div className="flex-1 space-y-1 rounded-lg border border-white/10 bg-black/30 p-3 text-zinc-300">
        ...
        <Row Icon={FolderOpen} indent label="serverbee" />
        <Row Icon={File} indent2 label="agent.toml" muted="1.1 KB" />
      </div>
      <div className="flex items-center gap-3">
        <Upload aria-hidden className="h-3 w-3 text-amber-300" />
        <span className="text-[10px] text-zinc-400">access.log → uploading</span>
        ...
        <span className="font-mono text-[10px] text-amber-300">64%</span>
      </div>
    </div>
  )
}
