...
The Agent has a very small resident footprint (single-digit MB memory + <1% CPU). For the full measured Agent and Server CPU/memory/disk/network data, see [Resource Usage](/en/docs/resource-usage).
