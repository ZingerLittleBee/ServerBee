...
```bash
wget https://github.com/ZingerLittleBee/ServerBee/releases/download/v1.0.0-beta.2/serverbee-agent-linux-amd64
...
docker run -d \
  ...
  ghcr.io/zingerlittlebee/serverbee-agent:1.0.0-beta.2
```
