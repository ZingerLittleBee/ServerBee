...
<Callout type="info">
File Manager requires additional agent-side configuration (`root_paths`, `deny_patterns`) for path sandbox security. See the [Agent Setup](/docs/en/agent) and [Configuration](/docs/en/configuration) pages for details.
</Callout>
