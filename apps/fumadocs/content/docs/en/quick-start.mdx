...
- A pre-built binary from the [releases page](https://github.com/ZingerBee/ServerBee/releases)
...
```bash
curl -fsSL https://raw.githubusercontent.com/ZingerBee/ServerBee/main/install.sh | bash
```
...
```
INFO  ServerBee v0.1.0 is ready
...
<Cards>
  <Card title="Server Configuration" href="/docs/en/server" />
  <Card title="Agent Configuration" href="/docs/en/agent" />
  <Card title="Set Up Alerts" href="/docs/en/alerts" />
