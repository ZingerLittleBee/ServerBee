...
ServerBee defines 6 capability bits, divided into two risk levels:
...
<Callout type="warn">
These capabilities involve executing arbitrary code or replacing binaries on the target server. They are disabled by default. Only enable them on trusted servers.
</Callout>
