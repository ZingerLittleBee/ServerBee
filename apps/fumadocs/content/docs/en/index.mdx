...
ServerBee is a lightweight VPS monitoring probe system -- similar in concept to [Nezha](https://github.com/nezhahq/nezha) or [Komari](https://github.com/komari-monitor/komari), but built from the ground up with a modern Rust backend and React frontend. It is designed to be fast, resource-efficient, and easy to deploy on small VPS instances.
