 ...
 * }
 */
import { defineWidget, type Infer, useServers, useTheme, type WidgetComponentProps, z } from '@serverbee/widget-sdk'

const ConfigSchema = z.object({
  greeting: z.string().describe('Greeting text').default('Hello, ServerBee')
})

type HelloWorldConfig = Infer<typeof ConfigSchema>

function HelloWorldWidget({ config }: WidgetComponentProps<HelloWorldConfig>) {
