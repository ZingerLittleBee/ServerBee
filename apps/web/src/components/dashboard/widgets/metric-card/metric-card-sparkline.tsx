...
import { Area, AreaChart, ResponsiveContainer } from '@/components/ui/recharts-lazy'
...
export function MetricCardSparkline({ points, accent }: MetricCardSparklineProps) {
  ...
  return (
    <Suspense fallback={<div className="h-full w-full" data-testid="metric-card-sparkline" />}>
