...
const settingsItems = [
  ...
  { to: '/settings/ping-tasks', labelKey: 'nav_ping_tasks', icon: Activity, adminOnly: true },
  { to: '/settings/service-monitors', labelKey: 'nav_service_monitors', icon: HeartPulse, adminOnly: true },
  ...
  { to: '/settings/appearance', labelKey: 'nav_appearance', icon: Palette, adminOnly: true },
