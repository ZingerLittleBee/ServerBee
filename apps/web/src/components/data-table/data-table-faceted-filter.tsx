    ...
    <div className="inline-flex items-center">
            ...
            <Button
              className={
                selectedValues.size > 0
                  ? 'h-8 rounded-r-none border-dashed font-normal'
                ...
                {options.map((option) => {
                  ...
                  return (
                    <CommandItem key={option.value} onSelect={() => onItemSelect(option, isSelected)}>
                      ...
                      {option.count ? <span className="ml-auto font-mono text-xs">{option.count}</span> : null}
                    </CommandItem>
                  )
                })}
              </CommandGroup>
      ...
      {selectedValues.size > 0 && (
        <Button
          ...
          className="-ml-px h-8 rounded-l-none border-dashed px-2"
          onClick={onReset}
          size="sm"
          type="button"
          variant="outline"
