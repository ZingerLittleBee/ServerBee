...
export const ChoroplethFeature = memo(function ChoroplethFeature({
  ...
  const { features, featurePaths, pathGenerator, projectPoint, isLoaded, revealEpoch, width, height } =
    useChoroplethStable()
  const { hoveredFeatureIndex, setHoveredFeatureIndex, setTooltipData } = useChoroplethInteraction()
  ...
  const records = useMemo(() => {
    ...
    return items
  }, [featureCentroids, featurePaths, features, fill, getFeatureColor, getFeaturePattern, pathGenerator])
