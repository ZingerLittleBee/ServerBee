...
import { LINE_LOADING_PULSE_EASE, LOADING_LABEL_EXIT_S, LOADING_LABEL_EXIT_Y_PX } from './line-loading-timing'
...
export function ChartLoadingLabel({ text = 'Loading', className, exiting = false }: ChartLoadingLabelProps) {
  if (!text.trim()) {
    return null
  }
