...
import { LINE_LOADING_LOOP_PAUSE_MS, LINE_LOADING_PULSE_CYCLE_S, LINE_LOADING_PULSE_EASE } from './line-loading-timing'
...
export function useGridShimmer({
  ...
  const shimmerX = useTransform(progress, (value) => -shimmerLength + value * (innerWidth + shimmerLength * 2))
