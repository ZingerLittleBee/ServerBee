...
function useGrowExitClip(innerWidth: number, mode: LineLoadingPulseMode, loopEpoch: number, onComplete?: () => void) {
    ...
    <>
      <defs>
        <clipPath id={clipPathId}>
          <motion.rect height={clipHeight} style={{ width: clipWidth, x: clipX }} y={-CLIP_PADDING} />
        </clipPath>
