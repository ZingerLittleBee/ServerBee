...
#[openapi(
    ...
    paths(
        ...
        crate::router::api::server::recover_server,
        crate::router::api::server::regenerate_code,
    ...
    components(
        schemas(
            ...
            crate::router::api::server::RecoverResponse,
            crate::router::api::server::RegenerateCodeRequest,
            crate::router::api::server::RegenerateCodeResponse,
