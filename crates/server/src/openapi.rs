...
#[openapi(
    ...
    paths(
        ...
        crate::router::api::server::create_server,
        crate::router::api::server::begin_reenrollment,
        crate::router::api::server::issue_offer_for_unclaimed,
        crate::router::api::server::replace_offer,
        crate::router::api::server::revoke_offer,
        crate::router::api::server::revoke_agent_authority,
        crate::router::api::server::get_agent_authority,
        crate::router::api::server::get_authority_history,
    ...
    components(
        schemas(
            ...
            serverbee_common::types::AgentAuthorityStatus,
            serverbee_common::types::AgentAuthorityStateSummary,
            crate::router::api::server::CreateServerRequest,
            crate::router::api::server::CreateServerResponse,
            crate::router::api::server::ReenrollmentModeRequest,
            crate::router::api::server::ReenrollmentRequest,
            crate::router::api::server::IssueOfferRequest,
            crate::router::api::server::EnrollmentOfferResponse,
            crate::router::api::server::RevokeOfferResponse,
            crate::router::api::server::RevokeAuthorityResponse,
            crate::router::api::server::AuthorityEventResponse,
            crate::router::api::server::EnrollmentIssueResponse,
            ...
            crate::service::cost::CostAdvisory,
            // mobile-auth
    ...
    tags(
        ...
        (name = "cost", description = "VPS cost insights and advisories"),
