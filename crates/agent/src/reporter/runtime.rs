...
pub(super) struct ConnectionRuntime {
    pub(super) capabilities: Arc<CapabilityAuthority>,
    pub(super) ping_manager: PingManager,
    pub(super) terminal_manager: TerminalManager,
    pub(super) network_prober: NetworkProber,
    pub(super) file_manager: FileManager,
    ...
    pub(super) docker_manager: Option<DockerManager>,
    docker_available: bool,
    pub(super) docker_stats_interval: Option<tokio::time::Interval>,
